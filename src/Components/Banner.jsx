...
import house from '../assets/img/house-banner.png'
    ...
    <section className='h-full  max-h-[500px] mb-8 xl:mb-24'>
        <div className='flex flex-col lg:flex-row'>
            ...
            lg:items-start text-center lg:text-left justify-center flex-1 px-4 lg-px-0'>
                ...
                <p className='max-w-[480px] mb-8'>Powerful, self serve product and growth analytics to help you convert, engage, and retain more.</p>
            </div>

            <div>
            <img src={house} alt='house'
             className='
             hidden flex-1 lg:flex justify-end items-end
             h-[500px]
             '></img>
            </div>
        </div>
